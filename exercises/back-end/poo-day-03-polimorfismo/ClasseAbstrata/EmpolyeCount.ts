...
class EmployeCount {
    ...
    private static employeeCount = 0
      ...
      private static addEmployee() {
        ...
        EmployeCount.employeeCount += 1;
        console.log(`Total de pessoas funcionárias: ${EmployeCount.employeeCount}`)
      }
    ...
    const employee1 = new EmployeCount('Kissyla'); // Total de pessoas funcionárias: 1
    const employee2 = new EmployeCount('Calaça'); // Total de pessoas funcionárias: 2
    const employee3 = new EmployeCount('Setinha'); // Total de pessoas funcionárias: 3
